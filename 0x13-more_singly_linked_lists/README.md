...
1.List lenght: Write a function that returns the number of elements in a linked listint_t list.
...
4.Free list: Write a function that adds a new node at the end of a listint_t list.
...
10. Delet at index: Write a function that deletes the node at index index of a listint_t linked list.
